...
const Header = () => {
  return (
    <header className='w-full h-20 md:w-[1109px]  md:h-[90px] mx-auto lg:mx-auto xl:mx-32px 2xl:mx-64px flex flex-col md:flex-row px-0 justify-center
     items-center'>
        ...
        <div className='md:w-[430px] h-[24px] flex justify-center text-center items-center gap-6 md:ml-32'>
          ...
          <div className='list'><Link href='/about'>About</Link></div>
